...
def personCount(root, in_file, output_dir, lineState = 'Horizontal', thresh = 0.5, roiThick = 7, offset = 0):     
        ...
        while cap.isOpened():
            ...
            if len(R):
                ...
                for i,r in enumerate(R):
                    ...
                    cv2.putText(frame, 'Person crossed : '+str(car_count), (0, int(WH[1])), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 2, cv2.LINE_AA)
                print '\n'
